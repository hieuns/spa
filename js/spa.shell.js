...
spa.shell = (function(){
  ...
  var
    ...
    jqueryMap = {},
    copyAnchorMap, setJqueryMap, changeAnchorPart, toggleChat,
    onHashchange, onClickChat, onResize, onTapAcct,
    onLogin, onLogout,
  ...
  //  * callback - optional function o execute at end of animation
  // Settings:
  ...
  //    * Manages the distinction between independent and dependent value
  //      in the encoding
  ...
  //  * Adjust the application only where proposed state differs form existing
  ...
  // Purpose : Change the chat component of the anchor It’s provided to Chat
  // Arguments:
